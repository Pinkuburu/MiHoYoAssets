...
namespace MiHoYoAssets.Utils
{
    public static class AES
    {
        ...
        static void MixCol(byte[] state, int off)
        {
            ...
            byte a2 = state[off + 2];
            byte a3 = state[off + 3];
            state[off + 0] = (byte)(LookupG2[a0] ^ LookupG3[a1] ^ a2 ^ a3);
            state[off + 1] = (byte)(LookupG2[a1] ^ LookupG3[a2] ^ a3 ^ a0);
            state[off + 2] = (byte)(LookupG2[a2] ^ LookupG3[a3] ^ a0 ^ a1);
            state[off + 3] = (byte)(LookupG2[a3] ^ LookupG3[a0] ^ a1 ^ a2);
        }
